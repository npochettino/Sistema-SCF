...
<body class="page-md login">
    ...
    <!-- BEGIN LOGO -->
    <div class="logo">
        <a href="login.aspx"><span style="color:white;font-size:30px">S.C.F SRL</span>
    ...
    <div class="content">
        ...
        <form class="login-form" action="index.aspx" method="post">
            ...
            <div class="alert alert-danger display-hide">
                ...
                <span>Ingresa algun usuario y contraseña. </span>
            </div>
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Usuario" name="username" id="txtUsuario" runat="server" required/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Contraseña" id="txtContraseña" runat="server" name="password" required />
                </div>
            </div>
