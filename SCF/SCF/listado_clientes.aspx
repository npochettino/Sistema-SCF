<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="listado_clientes.aspx.cs" Inherits="SCF.listado_clientes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="listado_clientes.aspx">Listado Clientes</a>
                        <i class="fa fa-circle"></i>
                    </li>
                </ul>
                <!-- END PAGE BREADCRUMB -->
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="form-body" style="height: 600px">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SCFConnectionString %>" SelectCommand="SELECT * FROM [Clientes]"></asp:SqlDataSource>
                                </div>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function Confirm() {
            ...
            if (confirm("Decea eliminar el cliente?")) {
