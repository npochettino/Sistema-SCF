<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="listado_facturas.aspx.cs" Inherits="SCF.listado_facturas" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body" style="height: 600px">
                                <!-- devexpress-->
                                <dx:ASPxGridView ID="gvFacturas" runat="server" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming="True" KeyFieldName="idFactura" Theme="Metropolis">
                                    <Columns>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SCFConnectionString %>" SelectCommand="SELECT * FROM [Facturas]"></asp:SqlDataSource>
                            </div>
